...
if os.environ.get('DJANGO_SECURE_SSL_REDIRECT') is not None:
    SECURE_SSL_REDIRECT = bool(int(os.environ.get('DJANGO_SECURE_SSL_REDIRECT')))
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'vue_built/vue/static'),
]
...
# Settings to include vue components
...
# Sendgrid settings
if DEBUG:  # In debug mode, just print the emails to the console
